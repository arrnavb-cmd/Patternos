  ...
  useEffect(() => {
    ...
    const fetchMetrics = async () => {
      try {
        ...
        const response = await fetch('https://patternos-production.up.railway.app/api/master/brand/Nike/metrics');
    ...
    const fetchBrandData = async () => {
      ...
      try {
        ...
        const orgResponse = await fetch(`https://patternos-production.up.railway.app/api/organizations/${brandSlug}`);
        const orgData = await orgResponse.json();
        
        // Fetch campaigns for this brand
        const campaignsResponse = await fetch(`https://patternos-production.up.railway.app/api/campaigns?organization_id=${orgData.id}`);
