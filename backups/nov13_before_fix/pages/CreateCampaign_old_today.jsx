...
import { Check, ArrowLeft, Upload, Sparkles, AlertCircle, Eye, Zap, Image as ImageIcon, Package, Target } from 'lucide-react';
...
export default function CreateCampaign() {
  ...
  const objectives = [
    { id: 'awareness', name: 'Brand Awareness', icon: '👁️', desc: 'Reach new audiences' },
    { id: 'consideration', name: 'Consideration', icon: '🤔', desc: 'Drive engagement' },
    { id: 'conversions', name: 'Conversions', icon: '��', desc: 'Drive sales' }
  ];
  ...
  const adTypesByPlatform = {
    zepto: [
      { id: 'sponsored_product', name: 'Sponsored Products', icon: '🏆', desc: 'Top of search results' },
      { id: 'banner', name: 'Banner Ads', icon: '🖼️', desc: 'Homepage & category pages' },
      { id: 'video', name: 'Video Ads', icon: '🎬', desc: 'Engaging video content' },
      { id: 'brand_of_day', name: 'Brand of the Day', icon: '⭐', desc: 'Premium homepage placement', tag: 'Premium' },
      { id: 'story', name: 'Story Ads', icon: '📱', desc: 'Stories & highlights' },
      { id: 'splash', name: 'Splash Screen', icon: '💥', desc: 'Full-screen app open', tag: 'High Impact' }
    ],
    facebook: [
      { id: 'fb_feed_image', name: 'Feed Image', icon: '📘', desc: 'Photo in news feed' },
      { id: 'fb_feed_video', name: 'Feed Video', icon: '🎬', desc: 'Video in news feed', format: 'video' },
      { id: 'fb_stories', name: 'Stories', icon: '📱', desc: 'Full-screen vertical stories' },
      { id: 'fb_reels', name: 'Reels', icon: '🎥', desc: 'Short-form video', format: 'video' },
      { id: 'fb_carousel', name: 'Carousel', icon: '🎠', desc: 'Multiple images/products', tag: 'Popular' },
      { id: 'fb_marketplace', name: 'Marketplace', icon: '🛍️', desc: 'Shopping section' }
    ],
    instagram: [
      { id: 'ig_feed_image', name: 'Feed Image', icon: '📸', desc: 'Photo in feed' },
      { id: 'ig_feed_video', name: 'Feed Video', icon: '🎬', desc: 'Video in feed', format: 'video' },
      { id: 'ig_stories', name: 'Stories', icon: '��', desc: 'Full-screen vertical stories' },
      { id: 'ig_reels', name: 'Reels', icon: '🎥', desc: 'Short-form video', format: 'video', tag: 'Trending' },
      { id: 'ig_carousel', name: 'Carousel', icon: '🎠', desc: 'Multiple images/products' },
      { id: 'ig_explore', name: 'Explore', icon: '🔍', desc: 'Discovery section' }
    ]
  };
  ...
  const platforms = [
    { 
      ...
      placements: [
        { id: 'search_top', name: 'Search - Top of Results', desc: 'Sponsored product at top of search', price: '₹15/CPM', category: 'Search' },
        { id: 'search_grid', name: 'Search - Product Grid', desc: 'Within search results grid', price: '₹10/CPM', category: 'Search' },
        { id: 'homepage_banner', name: 'Homepage Banner Carousel', desc: '6-8 rotating banner slots', price: '₹20/CPM', category: 'Homepage' },
        { id: 'homepage_featured', name: 'Homepage Featured Banner', desc: 'Static premium banner', price: '₹25/CPM', category: 'Homepage' },
        { id: 'homepage_trending', name: 'Trending Products Widget', desc: 'Sponsored product slots', price: '₹12/CPM', category: 'Homepage' },
        { id: 'homepage_video', name: 'Homepage Video', desc: 'Video storytelling placement', price: '₹30/CPM', category: 'Homepage', video: true },
        { id: 'category_banner', name: 'Category Top Banner', desc: 'Above category products', price: '₹14/CPM', category: 'Category' },
        { id: 'category_sponsored', name: 'Category Sponsored Products', desc: 'Within category listings', price: '₹11/CPM', category: 'Category' },
        { id: 'product_related', name: 'Product Page Related Items', desc: 'Below product description', price: '₹13/CPM', category: 'Product Page' },
        { id: 'cart_injection', name: 'Cart Recommendations', desc: 'Checkout page recommendations', price: '₹16/CPM', category: 'Cart' },
        { id: 'splash_screen', name: 'Splash Screen Takeover', desc: 'Full-screen on app open', price: '₹50/CPM', category: 'Premium', tag: 'Premium' },
        { id: 'brand_of_day', name: 'Brand of the Day', desc: 'Exclusive full-day homepage', price: '₹100/CPM', category: 'Premium', tag: 'Premium' }
      ]
    },
    { 
      id: 'facebook', 
      ...
      placements: [
        { id: 'fb_feed', name: 'Feed', desc: 'Main news feed', price: '₹10/CPM', size: '1080x1080', ratio: '1:1 or 4:5' },
        { id: 'fb_stories', name: 'Stories', desc: 'Full-screen vertical', price: '₹13/CPM', size: '1080x1920', ratio: '9:16' },
        { id: 'fb_reels', name: 'Reels', desc: 'Short video format', price: '₹14/CPM', size: '1080x1920', ratio: '9:16', video: true },
        { id: 'fb_marketplace', name: 'Marketplace', desc: 'Shopping section', price: '₹11/CPM', size: '1080x1080', ratio: '1:1' },
        { id: 'fb_right_column', name: 'Right Column (Desktop)', desc: 'Desktop sidebar', price: '₹5/CPM', size: '1080x1080', ratio: '1:1' },
        { id: 'fb_instream', name: 'In-Stream Video', desc: 'During video content', price: '₹12/CPM', size: '1280x720', video: true }
      ]
    },
    { 
      id: 'instagram', 
      ...
      placements: [
        { id: 'ig_feed', name: 'Feed', desc: 'Main Instagram feed', price: '₹11/CPM', size: '1080x1080', ratio: '1:1 or 4:5' },
        { id: 'ig_stories', name: 'Stories', desc: 'Full-screen vertical', price: '₹13/CPM', size: '1080x1920', ratio: '9:16' },
        { id: 'ig_reels', name: 'Reels', desc: 'Short-form video', price: '₹15/CPM', size: '1080x1920', ratio: '9:16', video: true },
        { id: 'ig_explore', name: 'Explore', desc: 'Discovery section', price: '₹12/CPM', size: '1080x1080', ratio: '1:1' },
        { id: 'ig_shop', name: 'Shopping Tab', desc: 'Product catalog', price: '₹10/CPM', size: '1080x1080', ratio: '1:1' }
      ]
    }
  ];
    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 py-8">
      <div className="max-w-5xl mx-auto px-4">
        <div className="mb-8">
          ...
          <p className="text-gray-400">Step {step} of 6 • {brand.brandName}</p>
        </div>
            ...
            <div className="grid grid-cols-2 gap-6 mb-6">
              ...
              >
                ...
                <ul className="space-y-1 text-xs text-gray-400">
                  <li>✓ AI optimizes delivery</li>
                  <li>✓ Best ROI</li>
                  <li>✓ One creative adapts</li>
                  <li>✓ Lower cost</li>
                </ul>
              </div>
                ...
                >
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-gray-400 text-sm">{p.category} • ₹{p.price.toLocaleString()}</p>
                    </div>
                  </div>
        ...
        {showPreview && (
          <div className="space-y-6">
            ...
            <div className="bg-gray-800 rounded-xl p-6">
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <p className="text-white font-medium">₹{parseInt(campaign.budget).toLocaleString()}/day</p>
                </div>
                <div>
            ...
            <div className="flex gap-4">
              ...
              <button 
                onClick={() => { 
                  alert(`🎉 Campaign created on ${getSelectedPlatform()?.name} successfully!`);
                  navigate('/campaigns');
                }}
