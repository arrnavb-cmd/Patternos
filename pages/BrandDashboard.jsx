...
export default function BrandDashboard() {
  ...
  const topCampaigns = [
    { name: 'Nike Air Max - Search', spend: 450000, sales: 2800000, roas: 6.2, status: 'active' },
    { name: 'Jordan Brand Display', spend: 380000, sales: 2100000, roas: 5.5, status: 'active' },
    { name: 'Running Shoes - Sponsored', spend: 320000, sales: 1950000, roas: 6.1, status: 'active' },
    { name: 'Apparel - Retargeting', spend: 210000, sales: 1100000, roas: 5.2, status: 'active' },
    { name: 'Nike Pro - Video', spend: 140000, sales: 800000, roas: 5.7, status: 'active' }
  ];
      ...
      <div className="max-w-7xl mx-auto px-4">
        ...
        <div className="bg-gradient-to-r from-orange-600 to-red-600 rounded-2xl p-8 mb-8 shadow-2xl">
          ...
          <p className="text-orange-100">
            Your campaigns are performing {metrics.roas > 5 ? 'excellently' : 'well'} - {metrics.roas}x ROAS
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
          ...
          <div className="bg-gradient-to-br from-gray-800 to-gray-900 rounded-xl p-6 border border-gray-700 shadow-xl">
            ...
            <p className="text-3xl font-bold text-white mt-1">{metrics.roas}x</p>
