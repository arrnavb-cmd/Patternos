...
export default function Profile() {
  ...
  const [profileData, setProfileData] = useState({
    companyName: getCurrentBrand().brandName + ' India',
    brandName: getCurrentBrand().brandName,
    email: getCurrentBrand().username,
    ...
    pincode: '560103',
    country: 'India',
    website: 'www.' + getCurrentBrand().brandKey + '.com',
    accountManager: 'Priya Sharma',
    accountType: 'Premium Brand Partner',
    memberSince: 'January 2024',
    billingEmail: 'billing@' + getCurrentBrand().brandKey + '.com',
